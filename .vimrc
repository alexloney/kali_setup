...
" Indent tabstop number of spaces when the tab key is pressed
set smarttab
...
" Use colors that suite a dark background
set background=dark
...
" Allow backspacing over indentation, line breaks, and inserted start
...
" Interpret octal and decimal when incrementing numbers
set nrformats-=octal
